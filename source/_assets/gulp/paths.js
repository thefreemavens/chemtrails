...
paths.scriptLibsName    = '/libs';
paths.stylesFolderName  = 'styles';
paths.jsonFolderName    = 'json';
...
paths.jsLibsFiles     = paths.assetsDir + paths.scriptFolderName + paths.scriptLibsName;
paths.imageFiles      = paths.assetsDir + paths.imageFolderName;
paths.fontFiles       = paths.assetsDir + paths.fontFolderName;
paths.jsonFiles       = paths.assetsDir + paths.jsonFolderName;
...
paths.jekyllJsonFiles  = paths.jekyllAssetsDir + paths.jsonFolderName;
...
paths.siteJsonFiles  = paths.siteAssetsDir + paths.jsonFolderName;
...
paths.jsonFilesGlob  = paths.jsonFiles  + paths.jsonPattern;
...
paths.jekyllJsonFilesGlob  = paths.jekyllJsonFiles  + paths.jsonPattern;
